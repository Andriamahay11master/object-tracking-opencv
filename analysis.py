...
# results. It computes average IoU, success rates at different
...
# Define success based on IoU thresholds (0.5 and 0.3)
...
sucess_rate_df = (
    df.groupby(["Tracker"])
    .agg({"Success Rate 50": "mean", "Success Rate 30": "mean"})
    .reset_index() * 100
)
